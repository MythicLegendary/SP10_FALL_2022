...
Please pick a path to an existing directory.`
    ...
    pluginInstance.getPathFromAResolvedNode = function getPathFromAResolvedNode({
      node,
      absolutePath
    }) {
      const filePath = _path.default.relative(pluginOptions.path, absolutePath); // URL path for the component and node
    ...
    pluginInstance.createAPageFromNode = function createAPageFromNode({
      ...
      const contentFilePath = (_node$internal = node.internal) === null || _node$internal === void 0 ? void 0 : _node$internal.contentFilePath; // URL path for the component and node
      ...
      this.knownPagePaths.add(path); // Params is supplied to the FE component on props.params

...
${errors.map(error => error.message).join(`\n`)}`.trim()
  ...
  let derivePathErrors = 0; // Start listening for changes to this type
  ...
  listOfTemplateFilePaths.add(absolutePath); // 3. Loop through each node and create the page, also save the path it creates to pass to the watcher

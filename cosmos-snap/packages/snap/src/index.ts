...
export const onRpcRequest: OnRpcRequestHandler = ({ origin, request }) => {
  ...
  switch (request.method) {
    ...
    case 'setConfig':
      //typescript typing problem. Should be same as cyb snap, but won't work. Just need to take the parameters from the request, put them in a dictionary, and call updatePluginState on them.
